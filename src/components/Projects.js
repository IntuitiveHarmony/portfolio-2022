      ...
      <div className="projectContainer">
        ...
        <div className="projectDeck">
          <div className="projectCard">
            ...
            <a
              href="https://intuitiveharmony.github.io/party-dots/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                className="projectImage"
                src={process.env.PUBLIC_URL + "/partyDots.png"}
                alt="KingfisherTieDye.com Thumbnail"
              />
            </a>
            <ul>
              <li className="projectBullet">
                React app that was built using only code generated by chat GPT
              </li>
              <li className="projectBullet">
                I wanted to explore what this AI program was capable of
              </li>
              <li className="projectBullet">
                I learned that while tools like these are powerful, they cannot
                make what I would call valued decisions
              </li>
            </ul>
          </div>
          <div className="projectCard">
            <h3>
              Tile-r{" "}
              <a
                href="https://github.com/IntuitiveHarmony/tile-r#readme"
                target="_blank"
                rel="noopener noreferrer"
              >
                <i className="soc fa-brands fa-github pinkLink gitLink"></i>
            ...
            <a
              href="https://intuitiveharmony.github.io/tile-r/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                className="projectImage"
                src={process.env.PUBLIC_URL + "/Tile-r.png"}
                alt="Tile-r Thumbnail"
              />
            </a>
            <ul>
              <li className="projectBullet">
                React app that allows user to tile and scale images from the web
              </li>
              <li className="projectBullet">
                I built this app to easily tile images that I was producing
                using{" "}
                <a
                  className="pinkLink"
                  href="https://www.midjourney.com/app/users/994343313958252645/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Midjourney
          ...
          <div className="projectCard">
            <h3>
              PolyBeast{" "}
              <a
                href="https://github.com/IntuitiveHarmony/breeze_front"
                target="_blank"
                rel="noopener noreferrer"
              >
                <i className="soc fa-brands fa-github pinkLink gitLink"></i>
            ...
            <a
              href="https://intuitiveharmony.github.io/breeze_front/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                className="projectImage"
                src={process.env.PUBLIC_URL + "/Polybeast.png"}
                alt="Polybeast Thumbnail"
              />
            </a>
            <ul>
              <li className="projectBullet">
                Full stack CRUD app that allows the user to make musical
                sequences of varying complexity, save their creation and edit it
                later
              </li>
              <li className="projectBullet">
                Collaborated with{" "}
                <a
                  className="pinkLink"
                  href="https://www.linkedin.com/in/jey-ulmer-70b141247/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Jey Ulmer
              ...
              <li className="projectBullet">
                Built using Django, Python, React, Redux, Tone.js, Reactronica,
                HTML5, CSS3, JavaScript, Heroku, Github, Github Pages
              </li>
            </ul>
          </div>
          {/* <div className='projectCard'>
